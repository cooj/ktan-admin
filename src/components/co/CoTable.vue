<template>
    <div ref="tablePageRef" class="table-page">
        ...
        <div class="flex-1 overflow-hidden">
            <!--   class="h100%!" -->
            <el-table ref="tableRef" :data="propsData.data" scrollbar-always-on highlight-current-row
...
const smallSize = computed(() => {
    return stores.themeConfig.globalComponentSize === 'small' || size.value === 'small'
})
